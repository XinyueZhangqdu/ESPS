...
class LoadData:
    ...
    def readFile(self, fileName, trainStg=False, addtional=None):
        ...
        min_val_al = 0
        max_val_al = 0
        with open(os.path.join(self.data_dir, fileName), 'r') as textFile:
            for line in textFile:
                ...
                if fileName=='train.txt':
                    img_file = ((self.data_dir).strip() + '/resize_images/' + str(name_num))
                    label_file = ((self.data_dir).strip() + '/resize_masks/' + str(name_num))
    ...
    def processDataAug(self):
        ...
        return_val1 = self.readFile('train.txt', True, addtional='')

        print('Processing validation data')
        return_val2 = self.readFile('val.txt', addtional='' )
