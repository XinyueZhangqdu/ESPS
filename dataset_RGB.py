...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, img_options=None):
        ...
        img_files = sorted(os.listdir(os.path.join(rgb_dir, 'resize_images')))
        mask_files = sorted(os.listdir(os.path.join(rgb_dir, 'resize_masks')))
        edge_files = sorted(os.listdir(os.path.join(rgb_dir, 'resize_masks')))
